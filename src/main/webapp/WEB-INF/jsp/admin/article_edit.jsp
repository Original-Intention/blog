...
<head>
    ...
    <script type="text/javascript" src="<%=root %>/js/ueditor/ueditor.all.js"> </script>
    <script type="text/javascript"  src="<%=root %>/js/lang/zh-cn/zh-cn.js"></script>
</head>
<body>
...
<div class="container">
    <form action="<%=root %>/admin/article/edit/do" method="post">
